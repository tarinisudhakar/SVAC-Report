...
The research, drafting, and publication of this report was carried out by Centre for Civil Society’s in-house team comprising Bhuvana Anand, Jayana Bedi, Pooloma Ghosh, Ritika Shah, Shruti Gupta and Vidushi Sabharwal. We are also grateful to Prashant Narang for his work on legal analysis. We thank C. K. Pushyami, Tarini Sudhakar, and Usha Sondhi Kundu for designing and Bushra Rashid for proofreading the study.
...
\addcontentsline{toc}{section}{Lessons From the Field: Challenges in Implementation}
...
We studied one TVC each in Delhi and Gurugram—the two connected urban spaces of the National Capital Region (NCR). \footnote{The NCR comprises National Capital Territory of Delhi and parts of Haryana, Uttar Pradesh and Rajasthan.} Further, 62.5\% of the total population of NCR is urban; of this, 56\% lives in Delhi \cite{ncrpbreport}. Congestion within Delhi has led to the emergence of satellite towns in surrounding areas such as Gurugram, Noida, Faridabad and Ghaziabad \cite{kpmgreport}. 
...
The Act requires each TVC, headed by the Municipal Commissioner, to have at least 10\% representation from NGOs or community-based organisations and 40\% from vendors. Other members may include representation from the local authority, traffic or local police, banks, vendors, market associations and resident welfare associations (RWAs). Per the order from MCG dated 7 August 2018, vendors account for only 14\% of the total TVC strength of 29 members (Appendix \ref{sec: List of TVC members}).
...
Management of public space is a pressing problem in most space starved urban cities. India’s cities are no exception. “On its streets, India eats, works, sleeps, moves, celebrates and worships. The street is a stage that rarely sleeps,”wrote Arjun Appadurai in 1987 \parencite{(Naik)}. This study concerns itself with the key contender on Indian urban public space—the street vendor. Vendors are often accused of encroaching street, of depriving pedestrians of their walking space or for causing traffic jams. Municipalities, supported by the police officials, are quick to act on the complaints. The result is: harassment, demands for bribes, arbitrary confiscations, and physical abuse. Such actions, although undesirable, are rare when residents claim parking spots in front of their houses or when shopkeepers encroach land. From whom are public spaces being safeguarded and who is safeguarded? 
...
n Gurugram, the MCG mandated list of TVC members had only 14\% (4/29) vendor representation as opposed to 40\% required by the Act. Vendor representatives present in actual meetings were different (and fewer)than those in the proposed list. Analysis of meeting minutes show that actions were taken against vendor demands, and this was after vendors raised complaints with three different authorities. The minutes had no space for the ‘voice’ of vendors—we know that vendors objected, the reasons for their objection were not recorded. 
...
\addcontentsline{toc}{section}{Appendix 4: Index Score Based on Quantum of Difference in Implementation of the Steps by Each State}

%Appendix 5
\section*{Appendix 5: Questionnaire for SV Act Implementation}
\addcontentsline{toc}{section}{Appendix 5: Questionnaire for SV Act Implementation}

%Appendix 6
\newpage
\section*{Appendix 6: List of TVC members as mandated by MCG}
\label{sec: List of TVC members}
\addcontentsline{toc}{section}{Appendix 6: List of TVC members as mandated by MCG}
\begin{figure}[h]
\centering
...
%Appendix 7
\newpage
\section*{Appendix 7: List of TVC members as per TVC \\Meeting of August 2018}
\addcontentsline{toc}{section}{Appendix 7: List of TVC members as per TVC \\Meeting of August 2018}
\begin{figure}[h]
\centering
...
%Appendix 7
\newpage
\section*{Appendix 8: Receipt of Maintenance Fee Paid by \\Vendors}
\addcontentsline{toc}{section}{Appendix 8: Receipt of Maintenance Fee Paid by Vendors}
\begin{figure}[h]
\centering
...
%Appendix 7
\newpage
\section*{Appendix 9: Complaint Made by a Private Party to MCG against RWA}
\addcontentsline{toc}{section}{Appendix 9: Complaint made by a private party to MCG against RWA} 
\begin{figure}[h]
\centering
